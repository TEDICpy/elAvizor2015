...
<div id="content" >
	<div class="widget-box">
		...
		<div class="pull-right compartir">
			Compartir
			<a href="https://twitter.com/intent/tweet?url=<?php echo url::site().'reports' ?>&text=%23elijopy Viendo reportes en" title="Compartir en Twitter" target="_blank">
		...
		<h1><?php echo Kohana::lang('ui_main.showing_reports_from', array(date('d/m/Y', $oldest_timestamp), date('d/m/Y', $latest_timestamp))); ?></h1>

		<div class="widget-content">
			<div class="row">


				<div id="reports-box1" class="col-md-8">
					<div>
						...
						<ul>
							...
							<li class="submenu">
								...
								<div style="position: relative; float: right; top: -31px; right: 40px; width:0">
									<a class="tltp" href="javascript:void(0)" onclick="removeParameterKey('c', 'fl-categories');" title="<?php echo Kohana::lang('ui_main.clear')?>">
							...
							<li class="submenu">
								...
								<ul>
									<li>
										...
										<div class="padding10 row clearfix">
										<?php echo form::open(NULL, array('method' => 'get')); ?>
											<div class="col-md-6">
												<strong><?php echo Kohana::lang('ui_admin.from')?>:</strong><br>
												<input id="report_date_from" type="text" style="width:90%;" />
											</div>
											<div class="col-md-6">
												<strong><?php echo ucfirst(strtolower(Kohana::lang('ui_admin.to'))); ?>:</strong><br>
												<input id="report_date_to" type="text" style="width:90%;" />
											</div>
											<div id="filterReportByDate" class="col-md-12 pt20">
												<a href="#" id="applyDateFilter" class="btn btn-inverse filter-button">
							...
							<!-- <li class="submenu">
								...
								<div style="position: relative; float: right; top: -31px; right: 40px; width:0">
									<a class="tltp" href="javascript:void(0)" onclick="removeParameterKey('mode', 'fl-incident-mode')" title="<?php echo Kohana::lang('ui_main.clear')?>">
										<i class="icon-remove-sign"></i>
									</a>
								</div>
							...
							<li class="submenu">
								...
								<div style="position: relative; float: right; top: -31px; right: 40px; width:0">
									<a class="tltp" href="javascript:void(0)" onclick="removeParameterKey('m', 'fl-media');" title="<?php echo Kohana::lang('ui_main.clear')?>">
										<i class="icon-remove-sign"></i>
									</a>
								</div>
							...
							<li class="submenu">
								...
								<div style="position: relative; float: right; top: -31px; right: 40px; width:0">
									<a class="tltp" href="javascript:void(0)" onclick="removeParameterKey('v', 'fl-verification');" title="<?php echo Kohana::lang('ui_main.clear')?>">
										<i class="icon-remove-sign"></i>
									</a>
								</div>
							...
							<!-- <li class="submenu">
								...
								<div style="position: relative; float: right; top: -31px; right: 40px; width:0">
									<a class="tltp" href="javascript:void(0)" onclick="removeParameterKey('cff', 'fl-customFields');" title="<?php echo Kohana::lang('ui_main.clear')?>">
										<i class="icon-remove-sign"></i>
									</a>
								</div>
								<ul>
