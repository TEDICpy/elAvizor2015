				...
				<div id="contact_us" class="row">
					...
					<div class="col-md-6">
						<div class="control-group">
							...
							<div class="controls">
								<?php print form::input('contact_name', $form['contact_name'], ' class="text long"'); ?>
							</div>	
						</div>
						<div class="control-group">
							<label class="control-label" for="contact_email"><?php echo Kohana::lang('ui_main.contact_email'); ?>:</label>
							<div class="controls">
								<?php print form::input('contact_email', $form['contact_email'], ' class="text long"'); ?>
							</div>	
						</div>
						<div class="control-group">
							<label class="control-label" for="contact_phone"><?php echo Kohana::lang('ui_main.contact_phone'); ?>:</label>
							<div class="controls">
								<?php print form::input('contact_phone', $form['contact_phone'], ' class="text long"'); ?>
							</div>	
						</div>
					</div>
					<div class="col-md-6">
						<div class="control-group">
							...
							<div class="controls">
								<?php print form::input('contact_subject', $form['contact_subject'], ' class="text long"'); ?>
							</div>	
						</div>
						<div class="control-group">
